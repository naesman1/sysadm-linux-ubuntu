...
- Seguimiento en tiempo real de CPU, memoria RAM y uso de sistemas de archivos (Filesystems)

### Estado de Servicios
- Verificación proactiva de servicios críticos (nginx, docker, ssh, mysql, kubelet)
- Comunicación con el bus de sistema del host

### Análisis de Seguridad
- Detección de intentos de inicio de sesión fallidos en `/var/log/auth.log`
- Escaneo de errores críticos en syslog
- Conteo de parches de seguridad pendientes

### Reportes Automatizados
- **Dashboard Web**: Interfaz visual limpia construida con Flask y Jinja2
...
- **Persistencia de Datos**: Los reportes se almacenan físicamente en el host mediante volúmenes de Docker
